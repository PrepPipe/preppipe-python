...
sudo python3 -m pip install llist odfpy python-docx chardet marko pillow pydub numpy scipy matplotlib opencv-python ghostscript editdistance bidict pypinyin graphviz
