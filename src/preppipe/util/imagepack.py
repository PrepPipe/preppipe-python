...
class ImagePack(NamedAssetClassBase):
  ...
  TR_imagepack_overview_prog_note = TR_imagepack.tr("overview_prog_note",
    en="This image pack is generated by the PrepPipe compiler.",
    zh_cn="本图包由语涵编译器生成。",
    zh_hk="本圖包由語涵編譯器生成。",
  )
  ...
  def write_overview_image(self, path : str):
    ...
    first_line += ' ' + self.TR_imagepack_overview_prog_note.get()
