...
from PySide6.QtWidgets import QPushButton, QLabel, QVBoxLayout, QSizePolicy, QLayout, QApplication, QMenu, QWidget
from PySide6.QtGui import QAction, QPalette
from PySide6.QtCore import Qt, Signal, QMetaObject, QThread, Q_ARG
from PySide6.QtGui import QResizeEvent, QFontMetrics, QFont, QMouseEvent, QPixmap
...
class AssetCardWidget(QPushButton):
  ...
  def __init__(self, asset_id: str, width: int, height: int, name_font=None, tags_font=None, parent=None):
    ...
    self._name_elide_margin = 8
    self._tags_elide_margin = 10
